    ...
    def completeStressMetrix():  # 完成应力矩阵。
        ...
        def solveForGivenStress():  # 求解给定平面上的正应力与切应力。
            ...
            def return_endir1(en):  # 将回车与程序的下一部分建立联系，使程序继续下去。
                ...
                length = math.sqrt(
                    dir_vec_ess[0][0] * dir_vec_ess[0][0] + dir_vec_ess[0][1] * dir_vec_ess[0][1] + dir_vec_ess[0][2] *
                    dir_vec_ess[0][2])
                for i in range(0, 3):
                    dir_vec_ess[0][i] = dir_vec_ess[0][i] / length
                stress_x = stress[0][0] * dir_vec_ess[0][0] + stress[0][1] * dir_vec_ess[0][1] + stress[0][2] * \
                                                                                                 dir_vec_ess[0][2]
                stress_y = stress[1][0] * dir_vec_ess[0][0] + stress[1][1] * dir_vec_ess[0][1] + stress[1][2] * \
                                                                                                 dir_vec_ess[0][2]
                stress_z = stress[2][0] * dir_vec_ess[0][0] + stress[2][1] * dir_vec_ess[0][1] + stress[2][2] * \
                                                                                                 dir_vec_ess[0][2]
                stress_square = stress_x * stress_x + stress_y * stress_y + stress_z * stress_z
                normal_stress = stress[0][0] * dir_vec_ess[0][0] * dir_vec_ess[0][0] + stress[1][1] * dir_vec_ess[0][
                    1] * dir_vec_ess[0][1] + stress[2][2] * dir_vec_ess[0][2] * dir_vec_ess[0][2] + \
                                2 * stress[0][1] * dir_vec_ess[0][0] * dir_vec_ess[0][1] + 2 * stress[0][2] * \
                                                                                           dir_vec_ess[0][0] * \
                                                                                           dir_vec_ess[0][2] + 2 * \
                                                                                                               stress[
                                                                                                                   2][
                ...
                def tranformation_from_stress_to_strain():  # 实现应力应变矩阵的转换。
                    ...
                    def solveForGivenStrain():  # 求解给定平面上的正应力与切应力。
                        ...
                        def return_endir2(en):  # 将回车与程序的下一部分建立联系，使程序继续进行。
                            ...
                            strain_x = strain[0][0] * dir_vec_ain[0][0] + strain[0][1] * dir_vec_ain[0][1] + strain[0][
                                                                                                                 2] * \
                                                                                                             dir_vec_ain[
                                                                                                                 0][2]
                            strain_y = strain[1][0] * dir_vec_ain[0][0] + strain[1][1] * dir_vec_ain[0][1] + strain[1][
                                                                                                                 2] * \
                                                                                                             dir_vec_ain[
                                                                                                                 0][2]
                            strain_z = strain[2][0] * dir_vec_ain[0][0] + strain[2][1] * dir_vec_ain[0][1] + strain[2][
                                                                                                                 2] * \
                                                                                                             dir_vec_ain[
                                                                                                                 0][2]
    ...
    def completeStrainMetrix():
        ...
        def solveForGivenStrain():
            ...
            def return_endir1(en):
                ...
                for i in range(0, 3):
                    dir_vec_ain[0][i] = dir_vec_ain[0][i] / length
                strain_x = strain[0][0] * dir_vec_ain[0][0] + strain[0][1] * dir_vec_ain[0][1] + strain[0][2] * \
                                                                                                 dir_vec_ain[0][2]
                strain_y = strain[1][0] * dir_vec_ain[0][0] + strain[1][1] * dir_vec_ain[0][1] + strain[1][2] * \
                                                                                                 dir_vec_ain[0][2]
                strain_z = strain[2][0] * dir_vec_ain[0][0] + strain[2][1] * dir_vec_ain[0][1] + strain[2][2] * \
                                                                                                 dir_vec_ain[0][2]
                strain_square = strain_x * strain_x + strain_y * strain_y + strain_z * strain_z
                normal_strain = strain[0][0] * dir_vec_ain[0][0] * dir_vec_ain[0][0] + strain[1][1] * dir_vec_ain[0][
                    1] * dir_vec_ain[0][1] + strain[2][2] * dir_vec_ain[0][2] * dir_vec_ain[0][2] + 2 * strain[0][1] * \
                                                                                                    dir_vec_ain[0][0] * \
                                                                                                    dir_vec_ain[0][
                                                                                                        1] + 2 * \
                                                                                                             strain[0][
