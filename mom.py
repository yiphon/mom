...
def solve_for_given_stress(dir_vec, a):
    ...
    normal_stress = a[0][0] * dir_vec[0][0] * dir_vec[0][0] + a[1][1] * dir_vec[0][1] * dir_vec[0][1] + a[2][2] * \
                                                                                                        dir_vec[0][2] * \
                                                                                                        dir_vec[0][2] + \
                    2 * a[0][1] * dir_vec[0][0] * dir_vec[0][1] + 2 * a[0][2] * dir_vec[0][0] * dir_vec[0][2] + 2 * \
                                                                                                                a[2][
                                                                                                                    1] * \
                                                                                                                dir_vec[
                                                                                                                    0][
...
def solve_for_given_strain(dir_vec, a):
    ...
    normal_strain = a[0][0] * dir_vec[0][0] * dir_vec[0][0] + a[1][1] * dir_vec[0][1] * dir_vec[0][1] + a[2][2] * \
                                                                                                        dir_vec[0][2] * \
                                                                                                        dir_vec[0][2] + \
                    2 * a[0][1] * dir_vec[0][0] * dir_vec[0][1] + 2 * a[0][2] * dir_vec[0][0] * dir_vec[0][2] + 2 * \
                                                                                                                a[2][
    ...
    print('The shear strain is {}.'.format(shear__strain))
    return 0
